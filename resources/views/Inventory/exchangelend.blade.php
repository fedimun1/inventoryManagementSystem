    ...
    <table id="transactionTable" class="display" style="border-radius: 10px;color:black ;background-color: #6677ef; width: 100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                @else
                <td>
                    <p style="font-size:14px;font-style: italic;color: blue">Mobile Banking</p>
                    <p>Bank : {{$tran->bankName}}</p>
                    <p>Acount Holder : {{$tran->AcHolder}}</p>
                    <p>Account Number: {{$tran->AccNumber}}</p>
                </td>
                @endif

                <td> {{$tran->name}}</td>
                <td>
                    <p>Name : {{$tran->custName}}</p>
                    <p>Phone : {{$tran->custPhone}}</p>
                    <p>TIN : {{$tran->TinNumber}}</p>
                </td>
...
<script type="text/javascript">
    //switcher
    function toggleTransactionFormContainer() {
        if ($('#transactionFormContainer').is(":hidden")) {
            $('#transactionFormContainer').show();
        } else {
            $('#transactionFormContainer').hide();
        }
    }
